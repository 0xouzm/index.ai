...
7. Structure:
   - Start with a brief introductory paragraph answering the question directly
   - Then provide numbered detailed points
   - AT THE VERY END, add a separate paragraph starting with "**总结**" (Chinese) or "**Summary**" (English) with practical insights
